...
const TABLE_HEAD = ["Trx", "User", "Gateway", "Amount","Charge","Upcoming Payment","Payment Date"];
...
export function InvestmentLogTable({data}) {
  ...
  return (
    <Card className="h-full w-full overflow-scroll bg-deepBlue mt-5 border border-white/20">
      <table className="w-full min-w-max table-auto text-left">
        ...
        <tbody>
          {data.map(({ transaction_hash, gateway,amount,charge,created_at,pending_invest }, index) => (
